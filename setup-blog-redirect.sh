#!/bin/bash
# Команда для добавления 301 редиректа с blog.speakid.ru на speakid.ru/blog/
# Выполни эту команду на сервере ПОСЛЕ изменения DNS
...
# Получаем SSL сертификаты из конфига speakid.ru
...
# Вставляем блок перед server_name speakid.ru
